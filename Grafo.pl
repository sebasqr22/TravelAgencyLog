...
arco(aeromexico, am657, mex, sjo, 3.0, de negocios , 300).
arco(avianca, am656 , sjo, mex, 3.0, ambas , 300). %mex

arcocopa, cm760, gru, pty, 7, de negocios, 1000). %brazil sao pablo
arco(latam, az681, gru, pty, 7, ambas, 1050). %brazil sao pablo

arcocopa, cm433, mex, pty, 4.10, economica, 400).
arco(united, cm432 , mex, pty, 4.10, de negocios , 500).

arcocopa, cm151, mde, pty, 0.40, economica, 200). %medellin colombia
arco(avianca, ar707 , mde, pty, 0.40, de negocios , 230). %medellin colombia

arco(copa, cm445, mco, pty, 3.40, de negocios, 420). %orlando
arco(american, ux042 , mco, pty, 3.40, economica , 420). %orlando

arco(copa, cm278, scl, pty, 6.30, de negocios, 700). %chile santiago
